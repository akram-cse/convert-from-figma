...
!function (t) {
    ...
    var c, l, f, u, s, d = "notdog-duo",
        ...
        p = (o(l = {}, "kit", "Kit"), o(l, "kit-duotone", "Kit Duotone"), "duotone-group"), y = "swap-opacity",
    ...
    function j(t, e) {
        var n = e && e.addOn || "", o = e && e.baseFilename || t.license + n, r = e && e.minify ? ".min" : "",
            i = e && e.fileSuffix || t.method, a = e && e.filename ? e.filename : o + r + "." + i,
    ...
    var S, O = function () {
        ...
        P = "undefined" == typeof setImmediate ? setTimeout : setImmediate, F = [];
    ...
    M.prototype = {
        constructor: M, _state: "pending", _then: null, _data: void 0, _handled: !1, then: function (t, e) {
    ...
    function q(t, n) {
        ...
        }, r = n.document || r, i = A.bind(A, r, [].concat(v, h.map((function (t) {
            return "fa-".concat(t)
        }))));
        t.autoA11y.enabled && o(i);
        var a = t.subsetPath && t.baseUrl + "/" + t.subsetPath, c = [];
        if (a ? c.push({id: "fa-main", addOn: void 0, url: a}) : c.push({
            id: "fa-main",
            addOn: void 0,
        ...
        var u = c.map((function (o) {
            return new R((function (r, i) {
                var a = o.url || j(t, {addOn: o.addOn, minify: t.minify.enabled}), c = {id: o.id},
    ...
    function X(t, n) {
        ...
        return t.v4shim.enabled && o.push(new R((function (o, r) {
            J(j(t, {addOn: "-v4-shims", minify: t.minify.enabled}), n).then((function (t) {
    ...
    try {
        if (window.FontAwesomeKitConfig) {
            var z = window.FontAwesomeKitConfig, $ = {
                ...
                document: document
            }, Q = document.currentScript, V = Q ? Q.parentElement : document.head;
            (function () {
